...
ORIG = '/Users/vikival/Downloads/dirty'
RESIZED_BASE = '/Users/vikival/Downloads/resized'
DIRS = {
  80: path.join(RESIZED_BASE, "80"),
  50: path.join(RESIZED_BASE, "50"),
  20: path.join(RESIZED_BASE, "20")
}
